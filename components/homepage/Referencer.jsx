  ...
  return (
    <div>
      <div className="referencer-container">
        <div className="referencer-text col-9">
          ...
          <p className="referencer-paragraph">
            ...
            eget. Elementum urna quam pharetra ultrices cursus at auctor. Metus
            viverra augue felis aliquam. Dignissim sodales in posuere et massa
            arcu augue in.
          </p>
        </div>

        <div className="referencer-families col-9">
